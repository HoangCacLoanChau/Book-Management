...
import chauhcl.registration.RegistrationDTO;
...
public class SearchLastnameServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       Map<String,String> roadmap = (Map<String, String>)request.getServletContext().getAttribute("ROAD");
        ...
        String url = roadmap.get("searchJSP");
        try  {
            ...
            log("SearchLastnameServlet Naming Exception  : " + ex.getMessage());
        }catch(SQLException ex){
            log("SearchLastnameServlet SQLException  : " + ex.getMessage());
        }catch (ClassNotFoundException ex) {
             log("SearchLastnameServlet ClassNotFoundException  : " + ex.getMessage());
        }finally{
