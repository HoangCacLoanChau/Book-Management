...
public class StartupServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url= roadmap.get("loginHTML");
        try  {
           //1. checking cookies
            ...
            if(cookies != null){
             ...
             log("StartupServlet SQLException : " + ex.getMessage());
        } catch (NamingException ex) {
            log("StartupServlet NamingException : " + ex.getMessage());
        } catch (ClassNotFoundException ex) {
            log("StartupServlet ClassNotFoundException : " + ex.getMessage());
